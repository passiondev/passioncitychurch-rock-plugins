...
namespace com.passioncitychurch
{
    ...
    /// </summary>
    public class PreRegistrationPersonRow : CompositeControl
    {
        ...
        /// </summary>
        public PreRegistrationPersonRow()
            : base()
        {
        ...
        protected override void CreateChildControls()
        {
            ...
            _tbNickName.RequiredErrorMessage = "First Name is required for all " + childPlural;
            _tbNickName.Label = "First Name";

            _tbLastName.Required = true;
            _tbLastName.RequiredErrorMessage = "Last Name is required for all " + childPlural;
            ...
            _ddlGender.RequiredErrorMessage = "Gender is required for all " + childPlural;
            ...
            _dpBirthdate.RequiredErrorMessage = "Birth date is required for all " + childPlural;
            ...
            _ddlGradePicker.RequiredErrorMessage = _ddlGradePicker.Label + " is required for all " + childPlural;
            _ddlGradePicker.Label = "Grade";

            _pnbMobile.CssClass = "form-control";
            _pnbMobile.Label = "Mobile Phone";
            _pnbMobile.RequiredErrorMessage = "A valid phone number is required for all " + childPlural;

            _ebEmail.Label = "Email Address";

            _ddlRelationshipType.CssClass = "form-control";
            _ddlRelationshipType.Required = false;
        ...
        public override void RenderControl( HtmlTextWriter writer )
        {
            if ( this.Visible )
            {
                ...
                {
                    writer.AddAttribute( HtmlTextWriterAttribute.Class, "col-sm-7" );
                    writer.RenderBeginTag( HtmlTextWriterTag.Div );
                ...
                {
                    writer.AddAttribute( HtmlTextWriterAttribute.Class, "col-sm-8" );
                    writer.RenderBeginTag( HtmlTextWriterTag.Div );
        ...
        public void SetAttributeValues( PreRegistrationPerson child )
        {
            EnsureChildControls();
        ...
        /// </summary>
        /// <param name="child">The child.</param>
        public void GetAttributeValues( PreRegistrationPerson child )
        {
            EnsureChildControls();
            int i = 0;
            foreach ( var attribute in AttributeList )
    ...
    /// </summary>
    [Serializable]
    public class PreRegistrationPerson
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PreRegistrationPerson"/> class.
        /// </summary>
        /// <param name="person">The person.</param>
        public PreRegistrationPerson( Person person )
        {
            Id = person.Id;
            Guid = person.Guid;
