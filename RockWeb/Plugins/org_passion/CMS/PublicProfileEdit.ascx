        ...
        <div style="padding: 15px;" class="panel panel-block">
            ...
            <div class="panel-body">
                ...
                <asp:Panel ID="pnlView" runat="server">
                    ...
                    <asp:LinkButton ID="lbRequestChanges" runat="server" CssClass="btn btn-primary btn-block btn-sm" OnClick="lbRequestChanges_Click"> Request Additional Changes</asp:LinkButton>
                            ...
                            <asp:Repeater ID="rContactInfo" runat="server">
                                <ItemTemplate>
                                    <div class="form-group">
                                        <div class="control-label col-md-12"><%# Eval("NumberTypeValue.Value")  %></div>
